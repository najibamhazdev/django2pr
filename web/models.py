...
class Blog(models.Model): 
    ...
    short_descr = models.CharField(_("Brief"), max_length = 300, null=True, blank=True)
...
class Sliders(models.Model):
    title = models.CharField(_("Title"), max_length = 200)
    short_descr = models.TextField(_("Brief"), null=True, blank=True)
...
class TextPages(models.Model):
    ...
    short_descr = models.TextField(_("Brief"), null=True, blank=True)
    body= models.TextField(_("Description"), null=True, blank=True)
...
class WebSettings(models.Model):
    ...
    small_description =  models.TextField(_("Brief"),null=True, blank=True)
